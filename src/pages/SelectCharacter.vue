<template>
    ...
    <div id="base" class="">
      ...
      <!-- Unnamed (组合) -->
      <div id="u4" class="ax_default" data-left="150" data-top="239" data-width="180" data-height="64">
        ...
        <div id="u7" class="ax_default label">
          ...
          <div id="u7_text" class="text ">
            <p><span style="text-decoration:none;">应用管理员</span></p>
          </div>
        </div>
      </div>
      ...
      <div id="u12" class="ax_default line">
        <img id="u12_img" class="img " src="images/选择角色/u8.svg"/>
      ...
      <!-- Unnamed (组合) -->
      <div id="u13" class="ax_default" data-left="150" data-top="409" data-width="180" data-height="64">

        <!-- Unnamed (矩形) -->
        <div id="u14" class="ax_default box_1">
          <img id="u14_img" class="img " src="images/选择角色/u5.svg"/>
      ...
      <!-- Unnamed (组合) -->
      <div id="u18" class="ax_default" data-left="350" data-top="409" data-width="180" data-height="64">

        <!-- Unnamed (矩形) -->
        <div id="u19" class="ax_default box_1">
          <img id="u19_img" class="img " src="images/选择角色/u5.svg"/>
        ...
        <div id="u20" class="ax_default label">
          ...
          <div id="u20_text" class="text ">
            <p><span style="text-decoration:none;">办公区管理员</span></p>
          </div>
        </div>
        ...
        <div id="u21" class="ax_default label">
          ...
          <div id="u21_text" class="text ">
            <p><span style="text-decoration:none;">自定义管理员</span></p>
          </div>
        </div>
      </div>
      ...
      <div id="u22" class="ax_default line">
        <img id="u22_img" class="img " src="images/选择角色/u8.svg"/>
      ...
      <!-- Unnamed (组合) -->
      <div id="u23" class="ax_default" data-left="150" data-top="579" data-width="180" data-height="64">

        <!-- Unnamed (矩形) -->
        <div id="u24" class="ax_default box_1">
          <img id="u24_img" class="img " src="images/选择角色/u5.svg"/>
